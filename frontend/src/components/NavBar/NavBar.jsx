  ...
  return (
    <>
      ...
      <div className="bg-[#D9D9D9]">
        <div className="mid h-[60px] flex justify-between items-center border border-slate-200 bg-[#D9D9D9] max-w-screen-2xl mx-auto ">
          <img
            src={logo}
            alt=""
          ...
          <div className="right flex items-center  mx-2 border border-black  space-x-3 mr-6">
            ...
            <Link
              to="/login"
              className="log hidden text-sm font-light md:block"
            >
              LOGIN
            </Link>
            <Link
