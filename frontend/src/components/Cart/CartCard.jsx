...
export const CartCard = () => {
  return (
    <>
      <div className="cartdetails main flex flex-col md:flex-row justify-start  bg-neutral-200 p-6 rounded-lg border-x-2 border-neutral-800 drop-shadow-lg  mb-8 lg:mr-4 lg:max-w-2/3 hover:translate-y-1 hover:ease-linear hover:duration-300">
