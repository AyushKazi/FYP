...
const Footer = () => {
  return (
    <div className="bg-[#2C2C2C]">
      <div className="footer grid grid-cols-1 bg-[#2C2C2C] lg:grid-cols-3">
        {/* news letter */}
        ...
        <div className="service px-5  py-4 md:px-10 lg:px-14">
          ...
          <ul>
            <li className="text-slate-300 text-sm py-2 font-light ">
              Address : Pokhara - 9, Mahendrapool, Nepal
            </li>
            <li className="text-slate-300 text-sm py-2 font-light ">
              Phone : +977 9813531120
            </li>
            <li className="text-slate-300 text-sm py-2 font-light ">
              Email : electrohub@gmail.com.np
            </li>
          </ul>
        </div>
      </div>
